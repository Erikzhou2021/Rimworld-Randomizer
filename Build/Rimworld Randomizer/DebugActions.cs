...
namespace Rimworld_Randomizer
{
    ...
    {
        [DebugAction("Item Randomizer", "Spawn Without Randomizing", allowedGameStates=AllowedGameStates.PlayingOnMap)]
        ...
        [DebugAction("Item Randomizer", "Spawn Reversed Random", allowedGameStates = AllowedGameStates.PlayingOnMap)]
